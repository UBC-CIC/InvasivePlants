const AlternativeSpeciesTestData = [
    {
        ...
        alternativeScientificName: "Perovskia atriplicifolia",
    ...
    },
    {
        ...
        alternativeScientificName: "Achillea millefolium hybrids",
    ...
    },
    {
        ...
        alternativeScientificName: "Anaphalis margaritacea",
        alternativeCommonName: ["Pearly everlasting"],
        description: "Pearly everlasting is an easy to care for perennial that thrives in hot, sunny spots – particularly disturbed sites. It produces slender green foliage and papery white flowers with yellow centres that bloom from early summer to fall. Appearance is quite variable depending on the site – this plant can be anywhere from 20 – 90 cm tall with leaves ranging in length from 2- 15 cm long and 0.5 – 2 cm wide.",
        image_links: ["http://example.com"]
    },
    {
        alternativeSpeciesId: 5,
        alternativeScientificName: "Limonium latifolium",
        alternativeCommonName: ["Sea Lavender"],
        description: "Sea lavender is an herbaceous perennial popular in cut flower arrangements for its dramatic display of small flowers. In the garden, it forms a cloud-like, mounding shape of these delicate blooms. Sea lavender is extremely heat and drought tolerant. Its flowers are loved by butterflies. This plant grows to 75 cm tall and 70 cm wide.",
        image_links: ["http://example.com"]
    },
];
