...
import { getInvasiveSpeciesScientificNamesBC } from '../functions/pipeline';
 ...
 *  - wiki url
 */
const webscrapeWikipedia = async (scientificName, speciesScore) => {
	try {
		...
		const speciesInfo = {
			scientificName: extractSpeciesName($),
